...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('LEAVE_APPROVED', 'LEAVE_REJECTED', 'LEAVE_PENDING', 'LEAVE_CANCELLED', 'PAYSLIP_UPLOADED', 'HOLIDAY_ANNOUNCEMENT', 'BIRTHDAY', 'WORK_ANNIVERSARY', 'COMPANY_ANNOUNCEMENT', 'GENERAL');
